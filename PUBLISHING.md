...
image: /images/updates/dilli-6-launch.jpg   # optional, must be under /images/ or /assets/
...
- Only files listed in `PUBLIC` in `scripts/build.mjs` are published. `_updates/`, scripts and docs never reach the live site.
